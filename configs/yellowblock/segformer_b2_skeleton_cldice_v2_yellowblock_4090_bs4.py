_base_ = ['../tp_dataset/segformer_b2_tp_skel_clDice_v2_4090_bs4.py']

work_dir = 'work_dirs/yellowblock/mmseg/segformer_b2_skeleton_cldice_v2_yellowblock_4090_bs4'
...
default_hooks = dict(
    checkpoint=dict(
        out_dir='work_dirs/yellowblock/mmseg/segformer_b2_skeleton_cldice_v2_yellowblock_4090_bs4/ckpt',
    )
)
