_base_ = ['../tp_dataset/pspnet_r50_tp_main_table1_B.py']

work_dir = 'work_dirs/yellowblock/mmseg/pspnet_r50_yellowblock_main_table1_B'
...
default_hooks = dict(
    checkpoint=dict(
        out_dir='work_dirs/yellowblock/mmseg/pspnet_r50_yellowblock_main_table1_B/ckpt',
    )
)
