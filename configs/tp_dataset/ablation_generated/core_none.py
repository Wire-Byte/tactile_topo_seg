...
work_dir = 'work_dirs/ablation/core_none'
...
model = dict(
    decode_head=dict(
        loss_decode=[
            ...
            dict(type='SoftCLDiceLoss', foreground_index=1, iterations=10, loss_weight=0.0),
        ],
    ),
    auxiliary_head=dict(
        ...
        loss_cldice=dict(type='SoftCLDiceLoss', foreground_index=0, iterations=10, loss_weight=0.0),
    ),
)
...
default_hooks = dict(
    checkpoint=dict(
        ...
        save_best='mIoU',
        rule='greater',
        out_dir='work_dirs/ablation/core_none/ckpt',
    ),
