_base_ = [
    '../../third_party/mmsegmentation/configs/deeplabv3plus/deeplabv3plus_r50-d8_4xb2-80k_cityscapes-512x1024.py',
]
...
default_hooks = dict(
    checkpoint=dict(
        ...
        save_best='mIoU',
        rule='greater',
        out_dir='work_dirs/deeplabv3plus_r50_tp_main_table1_B/ckpt',
    ),
...
work_dir = 'work_dirs/deeplabv3plus_r50_tp_main_table1_B'
