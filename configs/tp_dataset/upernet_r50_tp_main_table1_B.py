_base_ = [
    '../../third_party/mmsegmentation/configs/upernet/upernet_r50_4xb2-80k_cityscapes-512x1024.py',
]
...
default_hooks = dict(
    checkpoint=dict(
        ...
        save_best='mIoU',
        rule='greater',
        out_dir='work_dirs/upernet_r50_tp_main_table1_B/ckpt',
    ),
...
work_dir = 'work_dirs/upernet_r50_tp_main_table1_B'
