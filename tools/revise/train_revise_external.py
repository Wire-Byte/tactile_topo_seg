...
def main() -> None:
    ...
    if model_name == "vmunet" and val_keep_original_size:
        # VM-UNet requires aligned spatial sizes for skip merges.
        val_keep_original_size = False
        logging.warning(
            "[CALIBRATION] vmunet forces val_keep_original_size=False to avoid odd-size skip mismatch"
        )
